package com.jinnyshop5.order.controller;
...
public class OrderController {
    ...
    public @ResponseBody ResponseEntity order(@RequestBody OrderDto orderDto, BindingResult bindingResult, Principal principal){
